...
for line in data:
    ...
    testString = parts[2]
    # Part1
    # if int(counts[0])<= testString.count(letter) <= int(counts[1]):

    #Part2
    if (testString[int(counts[0])-1] == letter) != (testString[int(counts[1])-1] == letter):
        valid += 1
    # print("counts: "+counts[0]+"_"+counts[1]+" letters: "+letter+" testString: "+str(testString.count(letter)))
print(valid)
